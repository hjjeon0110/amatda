...
<body>
	...
	<div class="matchingTitleDiv">
		<label class="matchingTitle1">${ matchingTrainer.name } 트레이너님과의 PT는 즐거우셨나요? 그렇다면 즐겁게 리뷰를작성해 주세요!</label> <label class="matchingTitle2">리뷰작성</label>
	</div>
	<br>
	<div class="matchingTitleDiv">
			<input class="form-control" style="width: 350px;"type="text" id="title" placeholder="제목을 입력해주세요" />
			<!-- 별 넣기 -->
			...
			<br><br>
			<textarea class="form-control" name="reviewContent" id="reviewContent" cols="80" rows="5" style="resize:none; width: 40%; height: 200px !important;"></textarea>
			<br><br>
			<button id="writeReview" class="btn btn-primary">작성완료</button>
