	...
	<div class="searchTrainerListDiv">
		...
		<div class="trainerListDiv">
			<table class="trainerListTable">
				...
				<tr>
					...
					<td><button class="daysRemaining">3일 남음</button></td>
				</tr>
				<tr>
					<td><label class="simpleProfile">한 줄 프로필 공간입니다.</label></td>
					<td class="trainerListTableTd1">
						<button class="goProfileDetail" onclick="location.href='showProfileDetailPageView.us'">견적서 보기</button>
					</td>
				</tr>
			</table>
		</div>
		...
		<div class="trainerListDiv">
			<table class="trainerListTable">
				...
				<tr>
					<td><label class="simpleProfile">한 줄 프로필 공간입니다.</label></td>
					<td class="trainerListTableTd1"><button class="goProfileDetail">견적서 보기</button></td>
				</tr>
			</table>
		</div>
