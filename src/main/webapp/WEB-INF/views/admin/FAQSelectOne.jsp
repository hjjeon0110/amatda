					...
					<table class="table" id="FAQArea">
						<thead>
							<tr>
								...
								<th scope="col">${FAQ.bTitle }</th>
								
								<th scope="col"><fmt:formatDate pattern="yyyy-MM-dd" value="${FAQ.bWriteDate }"/></th>
								<th scope="col">${FAQ.bCount }
								<input type="hidden" id="bNo" value="${FAQ.bNo }"></th>
							</tr>
						</thead>

					</table>

					<textarea class="form-control" rows="15" required>${FAQ.bContent }</textarea>
					<div id="button">
