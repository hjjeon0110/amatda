			...
			<div class="col-12 tm-block-col">
				<div
					...
					<table class="table" id="declarationArea">
						<thead>
							<tr>
								<th scope="col">${ decl.decl_category } - ${decl.decl_classification}
								<input type="hidden" id="decl_no" value="${decl.decl_no }"></th>
								<th scope="col">${ decl.decl_title } </th>
								<th scope="col">${ decl.member.userId }</th>
								<th scope="col">${ decl.write_date }</th>
							</tr>
						</thead>
			
					</table>
					
					<textarea class="form-control" rows="15" required>${ decl.decl_content }</textarea>
				<div id="button">
					<a href="declaration.ad" class="button">목록</a>
	...
	<script>
		$(document).ready(function(){
			$("#deleteBtn").click(function(){
				...
				if(confirm("삭제하시겠습니까?")){
					//console.log("성공");
					var no = $("#declarationArea").find("input").val();
					location.href="deleteDeclaration.ad?decl_no=" + no;
