...
public class Attachment implements java.io.Serializable {
	...
	public Attachment(int fileNo, int bno, int pno, String link, String oriName, String modiName, String extension,
			int fileLevel, Date uploadDate, int aType, String aStatus, String filePath) {
		super();
		this.fileNo = fileNo;
		this.bno = bno;
		this.pno = pno;
	...
	public String toString() {
		return "Attachment [fileNo=" + fileNo + ", bno=" + bno + ", pno=" + pno + ", link=" + link + ", oriName="
				+ oriName + ", modiName=" + modiName + ", extension=" + extension + ", fileLevel=" + fileLevel
				+ ", uploadDate=" + uploadDate + ", aType=" + aType + ", aStatus=" + aStatus + ", filePath=" + filePath
				+ "]";
	}
